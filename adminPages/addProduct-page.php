<!-- 
    ...
    3- When an admin clicks add the form sends a query to the db with the information in the form ✓
...
<body class="bodyOfAdminPages">
    ...
    <div class="container-between-header-footer">
        ...
        <form method="post" action="" class="adminForm" enctype="multipart/form-data">
            ...
            <input type="text" name="ProductPrice" id="ProductPrice" class="adminforminput" value="<?php echo htmlspecialchars($Price); ?>">
            
            <label for="ProductStock" class="adminformlabel">Stock</label>
            <input type="number" name="ProductStock" id="ProductStock" class="adminforminput" value="<?php echo htmlspecialchars($Stock); ?>">

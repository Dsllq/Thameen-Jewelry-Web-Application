<!-- 
    ...
    3- Retrive the information from the db first then use the form to query 
    the database by overridng the old information (insert)✓
    4- Change "Cancle" to "Back" ✓
-->
<?php
    ...
    <div class="container-between-header-footer">
        ...
        ?>
                <form method="post" action="" class="adminForm" enctype="multipart/form-data"> <!-- the white contaner-->
                    ...
                    <input type="number" name="ProductPrice" id="ProductPrice" class="adminforminput" value="<?= $selectedProdect['price'] ?>" placeholder="Price">

                    <label for="ProductStock" class="adminformlabel">Stock</label>
                    <input type="number" name="ProductStock" id="ProductStock" class="adminforminput" value="<?= $selectedProdect['stock'] ?>">
